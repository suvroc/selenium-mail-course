...
namespace EndToEndMailCourse._03
{
    ...
    public class Workshop03Tests
    {
        ...
        public void ShouldCheckSelectedBookName()
        {
            ...
            IWebElement book = driver.FindElement(By.CssSelector("body > div > div:nth-child(2) > div > div > ul > li.list-group-item.book.selected"));
        ...
        public void ShouldCheckNumberOfBooks()
        {
            ...
            var books = ile1.FindElement(By.ClassName("list-group-item.book"));
        ...
        public void ShouldCheckLinksDomain()
        {
            ...
            var links = ile2.FindElement(By.ClassName("btn.btn-default"));
